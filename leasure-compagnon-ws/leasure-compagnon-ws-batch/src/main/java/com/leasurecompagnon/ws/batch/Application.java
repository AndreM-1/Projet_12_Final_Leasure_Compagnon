package com.leasurecompagnon.ws.batch;
...
import com.leasurecompagnon.ws.batch.mail.ConfigurationMail;
...
public class Application {
	...
	public static void main( String[] args ) {
		LOGGER.warn("************************Exécution de la méthode main.****************************");
		ApplicationContext vApplicationContext=new ClassPathXmlApplicationContext("classpath:/batchContext.xml");
		ConfigurationMail vConfigurationMail=vApplicationContext.getBean("configuration", ConfigurationMail.class);		
