...
public class GestionCreationCompteAction extends ActionSupport implements SessionAware {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4884858024337442839L;
	...
	public String doCreationCompte() {
		LOGGER.info("Méthode doCreationCompte()");
		String vResult;
		...
		if(civilite==null && nom==null && prenom==null && pseudo==null &&adresseMail==null && motDePasse==null && confirmationMotDePasse==null && 
